+ function(a) {
    ...
    var b = function(b, c) {
        ...
        var d = this;
        this.dropdowns = this.$element.hasClass("dropdown-toggle disable") ? this.$element.parent().find(".dropdown-menu").parent(".dropdown") : this.$element.find(".dropdown"), this.dropdowns.each(function() {
    ...
    a(document).ready(function() {
        ...
        clearTimeout(e), e = setTimeout(function() {
            a(window).width() >= 768 ? a('[data-hover="dropdown"]').each(function() {
                ...
                a(this).removeData("bs.dropdownhover"), a(this).hasClass("dropdown-toggle disable") ? a(this).parent(".dropdown").find(".dropdown").andSelf().off("mouseenter.bs.dropdownhover mouseleave.bs.dropdownhover") : a(this).find(".dropdown").off("mouseenter.bs.dropdownhover mouseleave.bs.dropdownhover")
            })
        }, 200)
    })
}(jQuery);