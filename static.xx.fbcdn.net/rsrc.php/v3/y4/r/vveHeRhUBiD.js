...
__d("observeIntersection", ["invariant", "ErrorGuard", "IntersectionObserver"], (function(a, b, c, d, e, f, g, h) {
    "use strict";
...
__d("stylex-runtime", ["styleq", "stylex-inject"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, b) {
        if (o.props) return o.props(a, b);
        b = (h || (h = d("styleq"))).styleq(a);
        a = b[0];
        b = b[1];
        var c = {};
        a != null && a !== "" && (c.className = a);
        b != null && Object.keys(b).length > 0 && (c.style = b);
        return c
    }
