    ...
    a = function(a) {
        ...
        function b() {
            ...
            return (b = d = a.call.apply(a, [this].concat(f)) || this, d.$1 = null, d.$2 = new(c("SubscriptionsHandler"))(), d.state = {
                visible: !1,
                wasEverVisible: !1
            }, d.tooltipEl = i.createRef(), b) || babelHelpers.assertThisInitialized(d)
        }
...
__d("DateStrings", ["fbt"], (function(a, b, c, d, e, f, g, h) {
    ...
    function c(a) {
        o || (o = [h._("Sun"), h._("Mon"), h._("Tues"), h._("Wed"), h._("Thurs"), h._("Fri"), h._("Sat")]);
        return o[a]
    }
...
__d("relay-runtime/store/RelayStoreUtils", ["invariant", "relay-runtime/util/RelayConcreteNode", "relay-runtime/util/getRelayHandleKey", "relay-runtime/util/stableCopy"], (function(a, b, c, d, e, f, g) {
    ...
    function q(a, b, c) {
        var d = {};
        c == !0 && (d[v.FRAGMENT_POINTER_IS_WITHIN_UNMATCHED_TYPE_REFINEMENT] = !0);
...
__d("relay-runtime/store/RelayModernSelector", ["invariant", "areEqual", "relay-runtime/store/RelayConcreteVariables", "relay-runtime/store/RelayStoreUtils", "warning"], (function(a, b, c, d, e, f, g) {
    ...
    function y(a, c) {
        return a.dataID === c.dataID && a.node === c.node && (h || (h = b("areEqual")))(a.variables, c.variables) && z(a.owner, c.owner)
    }
    ...
    e.exports = {
        areEqualSelectors: f,
        createReaderSelector: A,
        createNormalizationSelector: B,
...
__d("relay-runtime/store/RelayModernRecord", ["invariant", "areEqual", "relay-runtime/store/ClientID", "relay-runtime/store/RelayStoreUtils", "relay-runtime/store/experimental-live-resolvers/LiveResolverSuspenseSentinel", "relay-runtime/util/deepFreeze", "warning"], (function(a, b, c, d, e, f, g) {
    ...
    e.exports = {
        ...
        getErrors: A,
        getFields: y,
        getInvalidationEpoch: F,
        getLinkedRecordID: D,
        getLinkedRecordIDs: E,
        getType: z,
        getValue: B,
        hasValue: C,
        merge: H,
        ...
        setValue: K,
        setLinkedRecordID: L,
        setLinkedRecordIDs: M,
        update: G,
        getActorLinkedRecordID: O,
        setActorLinkedRecordID: N,
        getResolverLinkedRecordID: P,
...
__d("relay-runtime/store/OperationExecutor", ["invariant", "Promise", "relay-runtime/network/RelayObservable", "relay-runtime/store/ClientID", "relay-runtime/store/RelayConcreteVariables", "relay-runtime/store/RelayModernRecord", "relay-runtime/store/RelayModernSelector", "relay-runtime/store/RelayRecordSource", "relay-runtime/store/RelayStoreUtils", "relay-runtime/util/RelayError", "relay-runtime/util/RelayFeatureFlags", "relay-runtime/util/generateID", "relay-runtime/util/getOperation", "relay-runtime/util/stableCopy", "relay-runtime/util/withDuration", "warning"], (function(a, b, c, d, e, f, g) {
    ...
    var s = function() {
        function a(a) {
            ...
            m != null && this.$36(m.response != null ? {
                data: m.response
            } : null, m.updater, !1)
        }
        var c = a.prototype;
            ...
            c = function() {
                if (f != null) {
                    var b, c = {
                        __id: g,
                        __fragmentOwner: e.$7,
                        __fragments: (b = {}, b[f.name] = f.args ? I(f.args, e.$12) : {}, b)
                    };
                    b = {
        ...
        if (a.linkedField.plural) {
            ...
            return {
                ...
                ids: b.map(function(a) {
                    return V(a, "Expected this plural Client Edge Relay Resolver to return an array containing IDs or objects with shape {id}.")
                })
            }
        } else return {
            kind: "SingularConcrete",
            id: V(b, "Expected this Client Edge Relay Resolver to return an ID of type `string` or an object with shape {id}.")
        }
    }
    ...
    function a(a, b) {
        ...
        if (!e) {
            ...
            if (v != null && e.after == null && e.before == null) {
                ...
                p = v.getValue(n);
                b = v.getValue(o);
                (h || (h = d("ODS"))).bumpFraction(2507, "ufi_connection_generation_incremented", c("gkx")("708253") ? "comet" : "blue", 0, 1);
                if (r != null || u != null || p !== !0 && b !== !0) {
                    (h || (h = d("ODS"))).bumpFraction(2507, "ufi_connection_generation_incremented", c("gkx")("708253") ? "comet" : "blue", 1, 0);
...
__d("createRelayFBNetwork", ["DTSG", "ErrorGuard", "Promise", "cr:1110430", "gkx", "isPromise", "killswitch", "processRelayPrefetchURIsPayload", "processRelaySRPayload", "relay-runtime", "withLive", "withLiveClientPolling"], (function(a, b, c, d, e, f, g) {
    ...
    var h, i, j;
    b("cr:1110430");
    var k = c("killswitch")("RELAY_BLOCK_NETWORK_ON_3D_STATIC_RESOURCES") === !1 && !c("gkx")("708253");
    ...
    function m(a, c, d, e, f) {
        ...
        if (g != null && typeof g === "object") return new(h || (h = b("Promise")))(function(b) {
            l(a, c, function() {
                b(a)
            }, d, e, f)
        });
    ...
    function a(a, e, f, g) {
        var j = d("relay-runtime").Network.create(a, e);
        return {
            execute: function(a, d, e, o, p) {
                e = c("withLiveClientPolling")(a, c("withLive")(a, e));
                return k ? n(j.execute(a, d, e, o, p), function(d) {
                    if (Array.isArray(d)) {
                        var e = [],
                            j = !1;
                        d.forEach(function(b) {
                            b = m(b, a.name, f, p, g);
                            j = j || (i || (i = c("isPromise")))(b);
                            e.push(b)
                        });
                        return j ? (h || (h = b("Promise"))).all(e) : e
                    }
                    return m(d, a.name, f, p, g)
                }) : j.execute(a, d, e, o, p)["do"]({
                    next: function(b) {
                        Array.isArray(b) ? b.forEach(function(b) {
                            l(b, a.name, null, f, p, g)
                        }) : l(b, a.name, null, f, p, g)
                    }
                })
            }
...
__d("configureRelayFeatureFlagsForWWW", ["gkx", "qex", "relay-runtime"], (function(a, b, c, d, e, f, g) {
    ...
    function a() {
        var a;
        (a = d("relay-runtime")).RelayFeatureFlags.ENABLE_RELAY_RESOLVERS = !0;
        a.RelayFeatureFlags.ENABLE_CLIENT_EDGES = !0;
        a.RelayFeatureFlags.ENABLE_FIELD_ERROR_HANDLING = c("gkx")("5357");
        a.RelayFeatureFlags.ENABLE_FRIENDLY_QUERY_NAME_GQL_URL = c("gkx")("1723588");
        a.RelayFeatureFlags.ENABLE_LOAD_QUERY_REQUEST_DEDUPING = c("gkx")("1872325");
        a.RelayFeatureFlags.ENABLE_DO_NOT_WRAP_LIVE_QUERY = !0;
        a.RelayFeatureFlags.ENABLE_CONTAINERS_SUBSCRIBE_ON_COMMIT = !0;
        a.RelayFeatureFlags.STRING_INTERN_LEVEL = c("gkx")("3140") ? 2 : 0;
...
__d("configureRelayForWWW", ["FBLogger", "configureRelayFeatureFlagsForWWW", "configureRelayForFB", "cr:8217", "relay-runtime"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h = !1;
    ...
    function a() {
        ...
        b("cr:8217") != null && !d("relay-runtime").RelayFeatureFlags.ENABLE_OPERATION_TRACKER_OPTIMISTIC_UPDATES && !d("relay-runtime").RelayFeatureFlags.ENABLE_RELAY_OPERATION_TRACKER_SUSPENSE && b("cr:8217").inject();
